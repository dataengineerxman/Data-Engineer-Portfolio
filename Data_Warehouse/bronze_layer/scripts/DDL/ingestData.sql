...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM 'E:\Data_Engineering_Material\SQL\DataWarehouse\sql-data-warehouse-project\datasets\source_crm\cust_info.csv'
        ...
        FROM 'E:\Data_Engineering_Material\SQL\DataWarehouse\sql-data-warehouse-project\datasets\source_crm\prd_info.csv'
        WITH (FIRSTROW=2, FIELDTERMINATOR=',', ROWTERMINATOR='\n', TABLOCK);
        SET @EndTime = SYSDATETIME();
        ...
        FROM 'E:\Data_Engineering_Material\SQL\DataWarehouse\sql-data-warehouse-project\datasets\source_crm\sales_details.csv'
        WITH (FIRSTROW=2, FIELDTERMINATOR=',', ROWTERMINATOR='\n', TABLOCK);
        SET @EndTime = SYSDATETIME();
        ...
        FROM 'E:\Data_Engineering_Material\SQL\DataWarehouse\sql-data-warehouse-project\datasets\source_erp\CUST_AZ12.csv'
        WITH (FIRSTROW=2, FIELDTERMINATOR=',', ROWTERMINATOR='\n', TABLOCK);
        SET @EndTime = SYSDATETIME();
        ...
        FROM 'E:\Data_Engineering_Material\SQL\DataWarehouse\sql-data-warehouse-project\datasets\source_erp\LOC_A101.csv'
        WITH (FIRSTROW=2, FIELDTERMINATOR=',', ROWTERMINATOR='\n', TABLOCK);
        SET @EndTime = SYSDATETIME();
        ...
        FROM 'E:\Data_Engineering_Material\SQL\DataWarehouse\sql-data-warehouse-project\datasets\source_erp\PX_CAT_G1V2.csv'
        WITH (FIRSTROW=2, FIELDTERMINATOR=',', ROWTERMINATOR='\n', TABLOCK);
        SET @EndTime = SYSDATETIME();
